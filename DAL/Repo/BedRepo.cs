...
namespace DAL.Repo
{
    internal class BedRepo : Repo, IRepo<Bed, int, Bed>, ListofID<Bed,int>,Allotment<Bed,int>
    {
        ...
        public Bed GetData(int Bedid)
        {
            return db.Beds.FirstOrDefault(X=>X.Id.Equals(Bedid));
        }
